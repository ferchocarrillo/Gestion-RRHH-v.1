...
<div class="container">
                              ...
                              <div class="col-md-12">
                                  <div class="card">
                                    ...
                                    <th scope="row">{{ $entrevistas->id}}</th>
                                                ...
                                                <td>
                                                    <a href="{{url('/entJefe/'.$entrevistas->id.'/edit')}}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Entrevista Gerencia</a>
            ...
            Swal.fire(
              ...
              'Validacion de portulado por jefe inmediato',
              'success'
            )
            </script>
            @stop
