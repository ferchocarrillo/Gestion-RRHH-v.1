...
<div class="container">
    <div class="row">
        ...
        <label style="width:350px" for="resultadojefe">Resultado de la entrevista Jefe Inmediato:</label>
        &nbsp;&nbsp;

        <select  style="width:250px" name="resultadojefe" id="resultadojefe">resultado de la entrevista Jefe Inmediato
        ...
        <hr width=100%  align="center"  size=3  style="border:1px inset ; noshade="noshade">
        <label for="obsJefe">Observaciones</label>
        <textarea class="form-control" name="obsJefe" id="" cols="3" rows="3"></textarea>
...
<a href="{{route('home')}}" class="btn btn-info btn-lg active" role="button" aria-pressed="true">Regresar</a>
      ...
      Swal.fire(
        'ENTREVISTA',
        'Registre el resultado de la entrevista con el Jefe Inmediato',
        'success'
      )
      </script>
