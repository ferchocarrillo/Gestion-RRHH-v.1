...
<br>
    ...
    <form action="{{ url('/contratacion/')}}"
          ...
          <div class="container" style="background-image: linear-gradient(#EAF2F8, #AAB7B8); width: 830px; margin-center: .5rem;" >
...
<div class="row">
  <div class="col-sm-5">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title"><strong>Hoja de vida actualizada con foto</strong></h5>
        <div class="card">
  ...
  <div class="col-sm-5">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title"><strong>Fotocopia de  servicio publico</strong></h5>
        <div class="form-check form-check-inline">
