...
<div class="container" style="background-image: linear-gradient(#EAF2F8, #AAB7B8);">
 ...
 <div><input type="checkbox" id="resultadoGer" name="resultadoGer"  data-toggle="toggle" data-size="med" data-onstyle="success" data-offstyle="danger" data-on="Aprueba" data-off="No aprueba" ></div>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;
 <textarea name="obsGerencia" id="obsGerencia" cols="35" rows="3"></textarea>
