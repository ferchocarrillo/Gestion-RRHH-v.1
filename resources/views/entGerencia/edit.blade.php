...
<fieldset class="form-group">
 ...
 <p class="col-3">
  ...
  <input list="resultadoGer" type="text" name="resultadoGer" class="form-control" placeholder="Registre aqui el resultado" >
  ...
  <strong><span>Observaciones Gerencia</strong></span>
  <textarea  class="col-3" name="obsGerencia" id="obsGerencia" cols="165" rows="3"></textarea>
